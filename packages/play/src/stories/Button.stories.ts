...
export const Default: Story & {
  args: { content: string; type: string };
} = {
  argTypes: {
    content: {
      control: { type: "text" },
  ...
  play: async ({ canvasElement, args, step }: any) => {
    ...
    await step(
      ...
      async () => {
        ...
        expect((args as any).onClick).toHaveBeenCalledOnce();
        clearAllMocks();
      }
    );
    ...
    await step(
      ...
      async () => {
        ...
        expect((args as any).onClick).toHaveBeenCalledTimes(3);
        clearAllMocks();
      }
    );
    ...
    await step(
      ...
      async () => {
        ...
        expect((args as any).onClick).toHaveBeenCalledTimes(0);
...
export const Circle: Story = {
  ...
  play: async ({ canvasElement, args, step }: any) => {
    ...
    expect((args as any).onClick).toHaveBeenCalled();
  },
};
